...
public class Main {
    public static void main(String[] args) {
       ...
       System.out.println("Welcome to the Library Management System!");
            ...
            //            Utils.clearScreen(); // Clear the screen for better readability// Clear the screen for better readability
...
System.out.println("Books added to the library successfully!");
        ...
        // Create a loan
        System.out.println("Creating a loan for member1 and book1...");
        System.out.println("Please enter the loan start date (YYYY-MM-DD):");
        String startDateInput = scanner.nextLine();
        LocalDate startDate = LocalDate.parse(startDateInput);
        System.out.println("Please enter the loan end date (YYYY-MM-DD):");
        String endDateInput = scanner.nextLine();
        LocalDate endDate = LocalDate.parse(endDateInput);
        // Adjust the constructor arguments to match the Loan class definition
        // For example, if the correct order is (Book, Member, LocalDate, LocalDate):
                Loan loan1 = new Loan(book1, member1, startDate, endDate);
        headLibrarian.createLoan(cityLibrary, loan1);
